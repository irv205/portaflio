...
#Serializers
from project.apps.projects.serializers import ProjectsSerializers
from project.apps.workLine.serializers import WorkLineSerializers
...
class UserDetailSerializer(serializers.ModelSerializer):
    ...
    projects = ProjectsSerializers(many = True, required=False)
    work_line = WorkLineSerializers(many = True, required=False)
